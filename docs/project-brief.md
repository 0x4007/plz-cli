...
## Overview
plz-cli is a command-line interface tool that generates shell scripts from natural language descriptions using Claude 3.5 Sonnet. It simplifies terminal operations by allowing users to describe what they want to do in plain English.

## Core Requirements
1. Accept natural language prompts from users
2. Generate appropriate shell scripts using Claude 3.5 Sonnet
3. Execute generated scripts with user confirmation
4. Support environment configuration (ANTHROPIC_API_KEY)
